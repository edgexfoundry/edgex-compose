...
This branch contains the docker compose files that pull and run the `EdgeX Jakarta` release images.

These compose files are auto generated from the multiple files contained in the `compose-builder` folder. See [README](https://github.com/edgexfoundry/edgex-compose/tree/jakarta/compose-builder#readme) there for details.
