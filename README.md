## Edgex Docker Compose (Palau)

This branch contains the docker compose files that pull and run the ** EdgeX Palau** release images.

These compose files are auto generated from the multiple files contained in the `compose-builder` folder.
See Compose Builder [README](https://github.com/edgexfoundry/edgex-compose/blob/palau/compose-builder/README.md) for details.
